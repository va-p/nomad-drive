...
export const MainContent = styled.View`
  flex: 1;
  border-top-left-radius: ${({ theme }) => theme.borders.borderRadiusScreenSectionContent};
  border-top-right-radius: ${({ theme }) => theme.borders.borderRadiusScreenSectionContent};
  align-items: center;
  row-gap: 8px;
